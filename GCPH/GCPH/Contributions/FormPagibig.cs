...
namespace GCPH.Contributions
{
    public partial class FormPagibig : Form
    {
        ...
        private void LoadData()
        {
            ...
            con.dataGet("SELECT * FROM Pagibig");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (Validation())
            {
                con.dataSend("INSERT INTO Pagibig (Code, Minimum, Maximum, EE, ER) VALUES ('" + txtCode.Text + "','" + txtMin.Text + "','" + txtMax.Text + "','" + txtEE.Text + "','" + txtER.Text + "')");
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if (Validation())
            {
                con.dataSend("UPDATE Pagibig SET Minimum ='" + txtMin.Text + "', Maximum ='" + txtMax.Text + "', EE ='" + txtEE.Text + "', ER ='" + txtER.Text + "' WHERE Code = '" + txtCode.Text + "'");
        ...
        {
            con.dataSend("DELETE FROM Pagibig WHERE Code = '" + txtCode.Text + "'");
            LoadData();
            ClearData();
            btnSave.Enabled = true;
            btnUpdate.Enabled = false;
